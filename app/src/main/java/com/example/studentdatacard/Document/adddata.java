...
import com.example.studentdatacard.ModelUsers;
...
// encoding process plus uploading
    private void updateinsert(){
        ...
        pd.show();
        StorageReference mPictureRef = FirebaseStorage.getInstance().getReferenceFromUrl(model.getPurl()); //gets frb link
        mPictureRef.delete()
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        String filePathName = "Posts/" +(FirebaseAuth.getInstance().getCurrentUser().getUid()) + "/" + "post_" + timestamp;
...
//                                            .build().toString();  // encoding method


                                      //user account
                                    FirebaseDatabase.getInstance().getReference().child("students").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(model.getiD())
                                            .updateChildren(map)
                                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                @Override
                                                public void onSuccess(Void aVoid) {

                                                    FirebaseDatabase.getInstance().getReference().child("admin").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(model.getiD())
